...
def test_hysteresis_run_inputs_python(tmp_path):
...
def test_hysteresis_run_inputs_numpy_array(tmp_path):
...
def test_hysteresis_run_inputs_Quantity(tmp_path):
...
def test_hysteresis_run_inputs_Entity(tmp_path):
...
def test_hysteresis_run_radians(tmp_path):
