...
class Minimize:
  def __init__(self,external,exani,hmag,min_params):
    self.cum_time = 0.
    truncation, m_tol, grad_tol, precond_iter, iter_max, alphaMax, iterMax, verbose = min_params
    ...
    self._solver.getLineSearch().setOptions(alphaMax=alphaMax, iterMax=iterMax)
