...
class RosenFunc(CostFunction):
    ...
    def getDualProduct(self, m, g):
        """Return the dot product of g with m."""
        return np.dot(g, m)

    def getArguments(self, m):
        """Return precalculated values for current approximation m.
    ...
    def getInverseHessianApproximation(self, r, m, *args, initializeHessian=False):
        ...
        This function returns an approximation of the inverse Hessian
        at m for vector r.
        """
